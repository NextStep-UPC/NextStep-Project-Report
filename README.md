...
|:-------------------------|:------------------------|:-----------------|
| 1. Trabaja en equipo para proporcionar liderazgo | **Lecca Villalobos, Pedro Omar**<br>**TB1:** Realizó el Capítulo 2 completo del informe, redactó el Capítulo 1 (Introducción) y Capítulo 3 (Especificación de Requisitos), desarrolló los puntos 4.3 y 4.4 (relacionados a flujos de aplicaciones web), implementó la Landing Page, elaboró wireframes y mockups, completó los puntos 5.1.1 a 5.2.1.4 y de 5.2.1.6 a 5.2.1.8 en la sección de Sprint 1, además de finalizar las conclusiones generales y actualizar la versión final del documento. <br><br>**Espinoza Chavez, Moises Filemon**<br>**TB1:** Realizó los apartados de 4.1.1 (General Style Guidelines) y 4.1.2 (Web Style Guidelines), así como los puntos 4.2.1 a 4.2.5 relacionados al diseño visual y estructura de navegación del sistema. También redactó la sección 5.2.1.5 (Execution Evidence for Sprint Review).<br><br>**Geronimo Quispe, Pablo Antonio**<br>**TB1:** Realizó el punto 4.6. (Domain-Driven Software Architecture), aportando en la definición de arquitectura de componentes y contextos de software. | **Lecca Villalobos, Pedro Omar**<br>**TB1:** Mostró un liderazgo técnico sólido al asumir la responsabilidad de la redacción principal, la implementación técnica y la consolidación final del proyecto. <br><br>**Espinoza Chavez, Moises Filemon**<br>**TB1:** Lideró el diseño visual y estilización del proyecto, asegurando la coherencia en criterios visuales y de usabilidad.<br><br>**Geronimo Quispe, Pablo Antonio**<br>**TB1:** Contribuyó al liderazgo técnico en el modelado arquitectónico del sistema, asegurando una estructura coherente de software. |
| 2. Crea un entorno colaborativo, establece metas, planifica tareas y cumple objetivos | **Lecca Villalobos, Pedro Omar**<br>**TB1:** Planificó la estructura de capítulos del informe, organizó los entregables por hitos, implementó y desplegó la Landing Page en GitHub Pages, realizó pruebas manuales de validación y aseguró el cumplimiento de todos los objetivos del Sprint 1.<br><br>**Espinoza Chavez, Moises Filemon**<br>**TB1:** Propuso criterios de estilo para uniformizar la visualización del proyecto, apoyó la organización y revisión de entregables, y cumplió los tiempos de entrega de sus tareas asignadas.<br><br>**Geronimo Quispe, Pablo Antonio**<br>**TB1:** Participó en la definición de los artefactos de arquitectura, colaboró en el avance estructurado del informe y cumplió con los entregables dentro del Sprint 1. | **Lecca Villalobos, Pedro Omar**<br>**TB1:** Facilitó la coordinación general del equipo y garantizó la culminación exitosa de los productos comprometidos.<br><br>**Espinoza Chavez, Moises Filemon**<br>**TB1:** Aportó a un entorno de colaboración visual y organizativa, favoreciendo la consistencia general del proyecto.<br><br>**Geronimo Quispe, Pablo Antonio**<br>**TB1:** Contribuyó eficazmente al cumplimiento de metas técnicas y documentales dentro de los plazos establecidos. |
